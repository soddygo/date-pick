(function () {
    ...
    define('purchase/modules/header/header', function (require, exports, module) {
        require('purchase/modules/header/header.css');
        require('purchase/modules/header/header.tpl');
