<!--合同查询-->
<div class="purchase-pages-purchaseCreate content-container">
            ...
            <div class="table-responsive">
                ...
                <table class="cabinTable table table-hover  table-bottom-bordered table-event">
                    ...
                    <tr>
                        ...
                        <td><div><input class="form-control" value="商品编号1"></div></td>
                        <td><div>商品名称1</div></td>
                        <td><div>订购包装1</div></td>
                        <td><div><input class="form-control" value="12.45"></div></td>
                        <td><div>SK（库存单位）</div></td>
                        <td><div>20（库存单位数量）</div></td>
                        <td><div><input type="checkbox" id="checkbox1">
                            <label for="checkbox1">赠品</label></div></td>
                        <td><div>7.06%</div></td>
                        <td><div>20000</div></td>
                        <td><div>1234456</div></td>
                        <td><div>12342124</div></td>
                        <td><div><input type="checkbox" id="checkbox1">
                            <label for="checkbox1">允许超收</label></div></td>
                        <td><div>11%</div></td>
                    ...
                    <tr>
                        ...
                        <td><div><input class="form-control" value="12.45"></div></td>
                        <td><div>SK（库存单位）</div></td>
                        <td><div>10（库存单位数量）</div></td>
                        <td><div><input type="checkbox" id="checkbox1">
                            <label for="checkbox1">赠品</label></div></td>
                        <td><div>11.05%</div></td>
                        <td><div>21333</div></td>
                        <td><div>1235452324</div></td>
                        <td><div>3542343423</div></td>
                        <td><div><input type="checkbox" id="checkbox1">
                            <label for="checkbox1">允许超收</label></div></td>
                        <td><div>23.05%</div></td>
                        <td><div><span  class="event">查看详情</span></div></td>
