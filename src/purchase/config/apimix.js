define('purchase/config/apimix', function (require, exports, module) {
	var cgiCk = require('purchase/config/apilist'),
		handle = {},
		_fn;
	...
	_fn = {
		href: href,
		HOST: EVT + 'localhost.dmall.com:8080', //这里设置接口域名
		HOST1: EVT + 'localhost.dmall.com:8080', //设置多个接口域名
